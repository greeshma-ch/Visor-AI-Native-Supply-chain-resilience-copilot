                ...
                <div className="space-y-16">
                  ...
                  <section>
                    ...
                    <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className={`p-6 border-2 border-slate-900 rounded-xl flex items-center gap-4 ${currentRisk?.bg || 'bg-emerald-50'}`}>
                        ...
                        <div>
                          ...
                          <p className={`text-sm font-black uppercase ${currentRisk?.color || 'text-slate-900'}`}>Risk Level: {currentRisk?.label || 'Low'}</p>
                        </div>
                      </div>
                    </div>
                  </section>
